...
import LoanHistoryCard from "@/components/student/dashboard/LoanHistoryCard";
...
export default function LoanHistoryList({
  ...
  const iconClassName = [styles.showMoreIcon, showAllRequests ? styles.showMoreIconExpanded : ""]
    .filter(Boolean)
    .join(" ");
