...
// เรียกใช้ SharedRequestsList แทนของเดิม
    ...
    <div className="min-h-screen bg-[#f8fafc] flex font-sans text-gray-800">
      ...
      <div className="flex-1 flex flex-col w-full min-h-screen lg:ml-64">
        ...
        <main className="p-4 sm:p-6 lg:p-8 max-w-[1600px] w-full mx-auto">
          <WelcomeCard name="เจ้าหน้าที่ สมศรี" description="เจ้าหน้าที่กองพัฒนานักศึกษา (Admin)" />

          {/* ปรับ Grid เป็น 4 คอลัมน์ และเอาการ์ดของ Super Admin ออก */}
          ...
          <div className="mb-10">
            {/* เปลี่ยน URL ให้เป็นของ admin */}
            <FinancialOverview apiUrl="/api/admin/financial-overview" />
          </div>

          <section className="mb-10">
            <div className="flex items-end justify-between mb-4">
              <div>
                <h2 className="text-lg font-bold text-[#1e293b]">คำร้องรอตรวจสอบ (ภาพรวม)</h2>
                <p className="text-sm text-gray-500 mt-1">รายการคำร้องที่รอการตรวจสอบเอกสาร</p>
              </div>
              <a
                href="/admin/pending"
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
              {/* เรียกใช้ Shared Component พร้อม role="admin" */}
              <SharedRequestsList userRole="admin" hideFilters dashboardMode="pending" />
            </div>
          </section>
        </main>
      </div>
